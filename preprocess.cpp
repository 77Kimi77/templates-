...
void PrintError(const string& destination, const string& source, int string_number) {
    cout << "unknown include file "s << destination
        << " at file " << source << " at line "s << string_number << endl;
}
